...
public class EnigmaMachine {
    ...
    public void run() {
        ...
        rotorSettings();
        if(encrypting){
            System.out.println("Before Encrypting: " + before);
            encrypt();
        } else{
            System.out.println("Before Decrypting: " + before);
        }
        int index = 0;
        ...
        if (decrypting) {
            decrypt();
            System.out.println("After Decrypting: " + after);
        } else{
            System.out.println("After Encrypting: " + after);
        }
    }
